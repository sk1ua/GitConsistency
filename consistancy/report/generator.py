...
from consistancy.report.templates import (
    HTMLTemplates,
    MarkdownTemplates,
    ReportFormat,
    ReportTheme,
)
from consistancy.reviewer.models import ReviewResult
...
class ReportGenerator:
    ...
    def generate_github_comment(
        ...
        lines = [
            f"## 🔍 ConsistenCy Code Review - {project_name}",
            "",
        ...
        # 添加签名
        lines.append("---")
        lines.append(f"*Report generated by ConsistenCy v{self.version}*")
