...
class GitHubIntegration:
    ...
    COMMENT_SIGNATURE = "<!-- ConsistenCy 2.0 Code Review -->"
    ...
    async def update_pr_status(
        ...
        try:
            ...
            if has_issues:
                labels_to_add.append("consistancy:issues-found")
                labels_to_remove.append("consistancy:passed")
            else:
                labels_to_add.append("consistancy:passed")
                labels_to_remove.append("consistancy:issues-found")
