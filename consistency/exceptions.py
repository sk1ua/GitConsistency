...
class ScanError(GitConsistencyError):
    ...
    def __init__(self, message: str, scanner: str | None = None, details: dict[str, Any] | None = None) -> None:
...
class ScannerNotFoundError(ScanError):
    ...
    def __init__(self, scanner: str, details: dict[str, Any] | None = None) -> None:
...
class GitHubAuthError(GitHubError):
    ...
    def __init__(self, message: str = "GitHub 认证失败", details: dict[str, Any] | None = None) -> None:
...
class PromptError(AIReviewError):
    ...
    def __init__(self, message: str, prompt_name: str | None = None, details: dict[str, Any] | None = None) -> None:
...
class GitNexusConnectionError(GitNexusError):
    ...
    def __init__(self, message: str = "GitNexus 连接失败", details: dict[str, Any] | None = None) -> None:
        super().__init__(message, details=details)
...
class ReportError(GitConsistencyError):
    ...
    def __init__(self, message: str, format: str | None = None, details: dict[str, Any] | None = None) -> None:
